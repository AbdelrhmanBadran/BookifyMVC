...
{
    public partial class AddBooksAndBooksCateogryTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tilte = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_Tilte_AuthorId",
                table: "Books",
                columns: new[] { "Tilte", "AuthorId" },
                unique: true);
        }
